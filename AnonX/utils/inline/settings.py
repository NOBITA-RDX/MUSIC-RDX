    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="𝐀ᴜᴅɪᴏ ǫᴜᴀʟɪᴛʏ", callback_data="AQ"
            ),
            InlineKeyboardButton(
                text="𝐕ɪᴅᴇᴏ ǫᴜᴀʟɪᴛʏ", callback_data="VQ"
            ),
        ],
        [
            InlineKeyboardButton(
                text="𝐀ᴜᴛʜ ᴜsᴇʀs", callback_data="AU"
            ),
            InlineKeyboardButton(
                text="𝐂ʟᴇᴀɴ ᴍᴏᴅᴇ", callback_data="CM"
            ),
        ],
        [
            InlineKeyboardButton(
                text="• 𝐒ᴜᴩᴩᴏʀᴛ •", url=f"{SUPPORT_GROUP}",
            ),
            InlineKeyboardButton(
